...
bot = telebot.TeleBot('7030710589:AAEnH4iJSPt1nXthu_b5E1G6SuoWYaVZnWI') #telegram bot token from botfather

# Admin user IDs
admin_id = ["6427343545"] #admin id your tg id
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 300:
                response = "You Are On Cooldown. Please Wait 0min Before Running The /attack1 Command Again by STORM BOT @Itz_mohan_700 key valid till 2 days."
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "Usage :- /bgmi <target> <port> <time>\nBy Stoℝᴍ𒆜 BGMI | PVT | SEASON @Itz_mohan_700"  # Updated command syntax
    else:
        response = "You Are Not Authorized To Use This Command.\nBy STORM BOT https://t.me/MOHANMODS"
...
By STORM BOT FOR key dm @Itz_mohan_700 https://t.me/bgmisellingbuying'''
    bot.reply_to(message, response)
